...
(function(){
  ...
  function renderMainAgent(){
    ...
    if(!selected){status.textContent='尚未设置；设置后将创建“主Agent-'+workspaceShortName(state.board.workspacePath)+'”群聊';status.className='agent-status';mainAgentButton.textContent='设置';return;}
